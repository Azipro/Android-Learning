...
public class Main2Activity extends AppCompatActivity {
    ...
    private int images[] = {R.mipmap.banji,R.mipmap.l2,R.mipmap.l3,R.mipmap.l4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new SectionsPagerAdapter(getSupportFragmentManager(),images,name);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Context context) {
            image = getArguments().getInt("images");
...
//                    MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        private int []images;
        private String []name;
        public SectionsPagerAdapter(FragmentManager fm, int[] images,String []name) {
            super(fm);
            this.images = images;
            this.name = name;
        }
        ...
        public Fragment getItem(int position) {
            ...
            bundle.putInt("images",images[position]);
            bundle.putString("name",name[position]);
            return PlaceholderFragment.createFragment(bundle);
        }
